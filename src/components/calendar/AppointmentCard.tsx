...
export function AppointmentCard({ appointment, onClick, compact }: AppointmentCardProps) {
  ...
  return (
    <button
      ...
      className="w-full h-full text-left rounded-lg px-2 py-1 transition-all hover:opacity-80 cursor-pointer border border-transparent hover:border-border-secondary overflow-hidden"
      style={{
